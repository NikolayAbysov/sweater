...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) //Включает защиту методов по ролям. Аннотация @PreAuthorize("hasAuthority('ADMIN')")
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean //В целях отладки содержит данные пользователя в отдельном объекте
    @Override
